...
set(MIOSIX_TOOLCHAIN_FILE ${CMAKE_CURRENT_LIST_DIR}/miosix.toolchain.cmake)
cmake_print_variables(MIOSIX_TOOLCHAIN_FILE)
include(${MIOSIX_TOOLCHAIN_FILE})

set(MIOSIX_OPT_BOARD stm32f756zg_nucleo)
set(MIOSIX_ARCH_NAME cortexM7_stm32f7)
set(MIOSIX_CPU_MICROARCH armv7m)

set(MIOSIX_BSP_PATH ${CMAKE_CURRENT_LIST_DIR}/../bsps/${MIOSIX_OPT_BOARD})
