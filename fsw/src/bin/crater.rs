...
use crater_gnc::{
    ...
    mav_crater::{self, PressureSensorId, SensPressureSample_DATA},
    write_v2_msg_async,
};
use defmt::*;
...
async fn main(spawner: Spawner) {
    ...
    // let mut icm42688 = Icm42688::init(dev_icm_42688)
    //     .await
    ...
    loop {
        ...
        while let Some(sample) = rx_icm42688.try_next_message_pure() {
            let mav = sample
                .v
                .to_mavlink(mav_crater::ImuSensorId::Icm42688, sample.t);
